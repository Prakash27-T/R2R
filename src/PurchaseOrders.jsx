...
const poData = [
  { po: "PO-123", vendor: "Sharp Circuits India",    source: "Direct", ref: "-",       materials: 4, amount: "₹ 34,728",   delivery: "24/06/26", approval: "Draft",    approvalDot: "bg-gray-400",  status: "Draft",     updated: "12/05/26" },
  { po: "PO-122", vendor: "Texas Supplies",           source: "PR",     ref: "PR-88",   materials: 4, amount: "₹ 42,728",   delivery: "24/06/26", approval: "In Review",approvalDot: "bg-amber-400", status: "Open",      updated: "12/05/26" },
  { po: "PO-120", vendor: "Aryan Suppliers",          source: "Direct", ref: "-",       materials: 6, amount: "₹ 8,420",    delivery: "13/06/26", approval: "Approved", approvalDot: "bg-teal-400",  status: "Open",      updated: "12/05/26" },
  { po: "PO-119", vendor: "Dublin Components Ltd",    source: "RFQ",    ref: "RFQ-145", materials: 6, amount: "€ 5,420",    delivery: "13/06/26", approval: "Approved", approvalDot: "bg-teal-400",  status: "Open",      updated: "12/05/26" },
  { po: "PO-121", vendor: "Delta Electronics",        source: "Direct", ref: "-",       materials: 3, amount: "₹ 1,24,500", delivery: "22/06/26", approval: "Approved", approvalDot: "bg-teal-400",  status: "Received",  updated: "12/05/26" },
  { po: "PO-118", vendor: "Texas Industrial Supply",  source: "Direct", ref: "-",       materials: 8, amount: "$ 12,850",   delivery: "11/06/26", approval: "Approved", approvalDot: "bg-teal-400",  status: "Invoiced",  updated: "12/05/26" },
  { po: "PO-117", vendor: "Acme Office Supplies",     source: "Direct", ref: "-",       materials: 8, amount: "$ 22,430",   delivery: "09/06/26", approval: "Rejected", approvalDot: "bg-red-400",   status: "Cancelled", updated: "12/05/26" },
];
            ...
            <table className="w-full text-sm min-w-[860px]">
              ...
              <tbody>
                {paginated.map((row, i) => (
                  ...
                  >
                    <td className="px-4 py-3.5 text-gray-500 font-mono text-xs whitespace-nowrap">{row.po}</td>
                    <td className="px-4 py-3.5 text-gray-800 font-medium whitespace-nowrap">{row.vendor}</td>
                    <td className="px-4 py-3.5 text-gray-500 whitespace-nowrap">{row.source}</td>
                    <td className="px-4 py-3.5 text-gray-500 whitespace-nowrap">{row.ref}</td>
                    <td className="px-4 py-3.5 text-gray-700 font-semibold text-center">{row.materials}</td>
                    <td className="px-4 py-3.5 text-gray-700 font-medium whitespace-nowrap">{row.amount}</td>
                    <td className="px-4 py-3.5 text-gray-500 whitespace-nowrap">{row.delivery}</td>
                    <td className="px-4 py-3.5 whitespace-nowrap">
                      <span className={`flex items-center gap-1.5 text-xs font-medium ${approvalStyle[row.approval]}`}>
                        <span className={`w-2 h-2 rounded-full ${row.approvalDot} flex-shrink-0`} />
                        {row.approval}
                      </span>
                    </td>
                    <td className="px-4 py-3.5 whitespace-nowrap">
                    ...
                    <td className="px-4 py-3.5 text-gray-400 text-xs whitespace-nowrap">{row.updated}</td>
                  </tr>
                ))}
                {paginated.length === 0 && (
                  <tr>
